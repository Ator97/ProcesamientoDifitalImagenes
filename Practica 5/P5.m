...
%No se puede usar la convolución de tipo 'same', pues recorta el primer
%renglón y columna, lo que deja quita información, y deja un renglón y
%columna de ceros al final de la imagen.
...
%%Falta, no tengo el polinomio.
%Ya que se tenga la cúbica, solo falta ponerla en los subplot.
%A
...
%Para comprobar el padding:
%imshow(log(abs(I_frec_t2)),[])

%Interpolación en frecuencia con T=4:
